...
public class JobPostAdapter extends RecyclerView.Adapter<JobPostAdapter.MyViewHolder> {
    ...
    public JobPostAdapter(Context c , ArrayList<PostModel> p)
    {
        this.context = c;
        this.posts = p;
    }
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MyViewHolder(LayoutInflater.from(context).inflate(R.layout.jobemo_postview,parent,false));
    }
