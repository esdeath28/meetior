...
public class TrendingPostAdapter extends RecyclerView.Adapter<TrendingPostAdapter.MyViewHolder> {

    Context context;
    ArrayList<PostModel> posts;

    public TrendingPostAdapter(Context c , ArrayList<PostModel> p)
    {
        this.context = c;
        this.posts = p;
    }
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MyViewHolder(LayoutInflater.from(context).inflate(R.layout.eventpostrow,parent,false));
    }
