...
public class HelpPostAdapter extends RecyclerView.Adapter<HelpPostAdapter.MyViewHolder> {

    Context context;
    ArrayList<PostModel> posts;

    public HelpPostAdapter(Context c , ArrayList<PostModel> p)
    {
        this.context = c;
        this.posts = p;
    }
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MyViewHolder(LayoutInflater.from(context).inflate(R.layout.fulscreenpost,parent,false));
    }
